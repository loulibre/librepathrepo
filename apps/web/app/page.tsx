...
export default function Index() {
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-white py-4 px-6 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <svg
            ...
            className="text-blue-500 hover:text-blue-600 transition-colors flex-shrink-0 inline-block align-middle"
          >
          <g id="a">
          ...
          <span className="text-xl font-semibold inline-block align-middle">LibrePath</span>
        </div>
        <Link
          href="https://github.com/librepathai/librepathrepo"
      ...
      <div className="bg-blue-500 py-24 text-white">
